...
describe('Strategy', function () {
  ...
  describe('authorization request with Google Apps for Work parameters', function () {
    ...
    it('should be redirected', function () {
      expect(url).to.equal('https://accounts.google.com/o/oauth2/v2/auth?hd=http%3A%2F%2Flocalhost%3A3000%2Fgoogle%2Fcallback&response_type=code&client_id=306698060316-o39h5dfbkc5da3e6s8q2ehg6rpftmgpq.apps.googleusercontent.com');
    });
